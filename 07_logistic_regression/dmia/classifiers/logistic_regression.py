...
class LogisticRegression:
    ...
    def predict_proba(self, X, append_bias=False):
        ...
        prob_class_1 = self.sigmoid(X.dot(self.w))
    ...
    def loss(self, X_batch, y_batch, reg):
        ...
        predictions = self.sigmoid(X_batch.dot(self.w))
        loss = - (y_batch.dot(np.log(predictions)) + (1.0 - y_batch).dot(np.log(1.0 - predictions)))
